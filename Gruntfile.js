        ...
        files: [
          {
            ...
            src: ['js/**', 'css/**', 'fonts/**'], dest: 'public/vendor/bootstrap/'
          },
          {
          ...
          {
            expand: true, cwd: 'bower_components/x-editable/dist/bootstrap3-editable/',
            src: ['js/**', 'css/**', 'img/**'], dest: 'public/vendor/bootstrap-editable/'
          }
        ]
      }
    },
